...
export default function AlertModal({ isOpen, onRequestClose, children, type }) {
    ...
    return (
        <ReactModal
            ...
            overlayElement={(props, contentElement) => (
                <OverlayTransition
                    transitionTimingsInMS={transitionTimingsInMS}
                >
...
const ContentContainer = styled.div`
    ...
    max-width: 611px;
    padding: 45px 30px;
    background-color: ${(props) => props.theme.mode.modal.primary};
